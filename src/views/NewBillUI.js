            ...
            <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <div class="col-half">
                    ...
                    <input required type="file" accept=".jpg,.jpeg,.png,.pdf" class="form-control blue-border" data-testid="file" />
                    <div class="error-extension-file">Votre justificatif doit être au format jpg, jpeg, png ou pdf.
                    </div>
                  </div>
                </div>
            </div>
